...
const Config = {
  ...
  /** infobip */
  // INFOBIP
  domainInfobip: process.env.INFBP_DOMAIN,
  usernameInfobip: process.env.INFBP_USERNAME,
  passwordInfobip: process.env.INFBP_PASSWORD,
  mailFromInfobip: process.env.INFBP_MAIL_FROM,
  /**jsonwebtokens */
  jwtSecretKey: process.env.JWT_SECRET_KEY,
  autorization: `ASIS ${process.env.AUTHORIZATION}`,
  /**crypt js */
